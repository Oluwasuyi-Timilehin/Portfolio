...
const Homeskill = () => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-950 py-16 lg:py-28">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <div className="space-y-4 text-zinc-600 dark:text-zinc-300 leading-relaxed">
              <p>
                ...
                building my skills in core frontend technologies. Here's where I
                currently stand in my learning journey:
              </p>
